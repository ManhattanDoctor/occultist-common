...
export enum PaymentTransactionType {
    ...
    TAROT_SPREAD_MEANING_CONVERSATION_MESSAGE_PURCHASE = 'TAROT_SPREAD_MEANING_CONVERSATION_MESSAGE_PURCHASE',
    TAROT_SPREAD_MEANING_AI_CONVERSATION_MESSAGE_PURCHASE = 'TAROT_SPREAD_MEANING_AI_CONVERSATION_MESSAGE_PURCHASE'
}
