...
export class Demons extends FilterableMapCollection<Demon> {
    ...
    private addSimilar(): void {
        this.get(DemonName.BAEL).addSimilar(this.get(DemonName.GAAP), this.get(DemonName.MARBAS), this.get(DemonName.GUSION), this.get(DemonName.YPOS), this.get(DemonName.SABNOK), this.get(DemonName.AMDUCIAS), this.get(DemonName.NABERIUS));
        this.get(DemonName.AGARES).addSimilar(this.get(DemonName.AMON), this.get(DemonName.HALPHAS), this.get(DemonName.MALPHAS), this.get(DemonName.OROBAS), this.get(DemonName.VALAC), this.get(DemonName.DANTALION), this.get(DemonName.PHENEX));
        this.get(DemonName.VASSAGO).addSimilar(this.get(DemonName.PHENEX), this.get(DemonName.HAAGENTI), this.get(DemonName.DECARABIA), this.get(DemonName.BUNE));
        this.get(DemonName.GAMIGIN).addSimilar(this.get(DemonName.FURFUR), this.get(DemonName.RAUM), this.get(DemonName.MURMUR));
        ...
        this.get(DemonName.AMON).addSimilar(this.get(DemonName.AGARES), this.get(DemonName.BOTIS), this.get(DemonName.PHENEX), this.get(DemonName.BIFRONS), this.get(DemonName.OROBAS), this.get(DemonName.DANTALION), this.get(DemonName.MALPHAS), this.get(DemonName.BUNE));
        ...
        this.get(DemonName.SITRI).addSimilar(this.get(DemonName.ASMODAI), this.get(DemonName.BALAM), this.get(DemonName.GREMORY), this.get(DemonName.BELETH));
        this.get(DemonName.BELETH).addSimilar(this.get(DemonName.ELIGOS), this.get(DemonName.SALLOS), this.get(DemonName.BERITH), this.get(DemonName.FORNEUS), this.get(DemonName.CROCEL), this.get(DemonName.SITRI));
        ...
        this.get(DemonName.BATHIN).addSimilar(this.get(DemonName.STOLAS), this.get(DemonName.VEPAR), this.get(DemonName.MURMUR), this.get(DemonName.AMY), this.get(DemonName.ORIAS), this.get(DemonName.BERITH), this.get(DemonName.HAAGENTI));
        this.get(DemonName.SALLOS).addSimilar(this.get(DemonName.BELETH), this.get(DemonName.ELIGOS), this.get(DemonName.MARAX), this.get(DemonName.FORNEUS), this.get(DemonName.CROCEL), this.get(DemonName.FURFUR), this.get(DemonName.FURCAS), this.get(DemonName.ALLOCES));
        this.get(DemonName.PURSON).addSimilar(this.get(DemonName.MARAX), this.get(DemonName.NABERIUS), this.get(DemonName.FORAS), this.get(DemonName.STOLAS), this.get(DemonName.SHAX), this.get(DemonName.CAMIO), this.get(DemonName.ORIAS), this.get(DemonName.ZAGAN), this.get(DemonName.ASTAROT));
        ...
        this.get(DemonName.YPOS).addSimilar(this.get(DemonName.MARAX), this.get(DemonName.BAEL), this.get(DemonName.ANDRAS), this.get(DemonName.ANDREALPHUS), this.get(DemonName.AIM));
        this.get(DemonName.AIM).addSimilar(this.get(DemonName.LERAIE), this.get(DemonName.GAAP), this.get(DemonName.CAMIO), this.get(DemonName.ANDREALPHUS), this.get(DemonName.ANDROMALIUS), this.get(DemonName.MURMUR), this.get(DemonName.YPOS));
        ...
        this.get(DemonName.BUNE).addSimilar(this.get(DemonName.AMON), this.get(DemonName.BOTIS), this.get(DemonName.BIFRONS), this.get(DemonName.ANDRAS), this.get(DemonName.VASSAGO));
        this.get(DemonName.RONOVE).addSimilar(this.get(DemonName.PAIMON), this.get(DemonName.VELEFOR), this.get(DemonName.VINE), this.get(DemonName.OSE), this.get(DemonName.VAPULA), this.get(DemonName.VEPAR));
        ...
        this.get(DemonName.ASTAROT).addSimilar(this.get(DemonName.NABERIUS), this.get(DemonName.STOLAS), this.get(DemonName.CAMIO), this.get(DemonName.ANDRAS), this.get(DemonName.AMDUCIAS), this.get(DemonName.FORAS), this.get(DemonName.PURSON));
        ...
        this.get(DemonName.VEPAR).addSimilar(this.get(DemonName.VELEFOR), this.get(DemonName.RONOVE), this.get(DemonName.BATHIN), this.get(DemonName.HAAGENTI));
